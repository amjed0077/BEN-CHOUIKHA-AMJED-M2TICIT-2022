...
class VoyageViewPage extends StatefulWidget {
  final Voyage voyage;
  const VoyageViewPage({Key? key, required this.voyage}) : super(key: key);

  @override
  _VoyageViewPageState createState() => _VoyageViewPageState();
}

class _VoyageViewPageState extends State<VoyageViewPage> {
        ...
        SliverAppBar(
          ...
          flexibleSpace: FlexibleSpaceBar(
              ...
              background: Image.network(
                "http://127.0.0.1:8000/storage/voyages/" + widget.voyage.image,
                fit: BoxFit.cover,
              )),
